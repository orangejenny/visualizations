...
# Change, absolute value: climate change, guns: climate changes persists, and oddly so does sales or inc
...
# Comparing low-income new parents with other low-income people: climate change, jobs env
